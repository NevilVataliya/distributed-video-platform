      ...
      >
        <div className="rounded-2xl border border-border bg-card p-10 shadow-sm">
          ...
          <div className="flex flex-col items-center mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold font-display text-foreground tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-[34px] p-1 text-muted-foreground hover:text-foreground transition-colors rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
            ...
            <Button type="submit" className="w-full h-11 text-[15px] font-semibold tracking-wide" disabled={loading}>
          ...
          <div className="mt-8 text-center text-sm border-t border-border/60 pt-6">
            ...
            <Link to="/register" className="font-semibold text-foreground hover:text-primary transition-colors underline underline-offset-4 decoration-border hover:decoration-primary">
              Sign up
            </Link>
          </div>
        </div>
